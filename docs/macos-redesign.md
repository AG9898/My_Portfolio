...
### Dock
- Centered at bottom
- Contains icons for each main section plus the promoted Cloo showcase: Home, Projects, About, Contact, CV, Cloo
...
The Cloo showcase opens `/cloo` from the Dock using Cloo's approved `cloo-product.svg`
